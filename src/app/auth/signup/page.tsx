...
//     window.location.href = `https://api.descope.com/oauth/authorize?provider=${provider}&project_id=${projectId}&redirect_url=${redirectUrl}`
//   }
...
//     setLoading(true)
//     try {
//       const response = await fetch('https://api.descope.com/v1/auth/signup/password', {
//         method: 'POST',
